...
def main():
    print("=" * 70)
    print("SMOLLM2 PRACTICAL ENSEMBLE V9 ON ENWIK8")
    print("=" * 70)
            ...
            for k, (block, T0, NC, n_new) in enumerate(chunk):
                ...
                for t_idx in range(T0, T0 + NC):
                    ...
                    if ib < 0 and it < 0:
                        ...
                        rank = nb_find_rank(_out_idx, _n, target)
    ...
    results = {
        "model": "SmolLM2-135M-practical-ensemble-v9",
    ...
    with open(f"./data/smollm2_ensemble_v9_{tag}.json", "w") as f:
        json.dump(results, f, indent=2)
    print(f"\nSaved to data/smollm2_ensemble_v9_{tag}.json")

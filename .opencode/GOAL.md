...
- Updated: 2026-09-16T02:40:00+08:00
## Objective
...
## Must read first
- data/sota_loop.json（308 條 ledger）
...
## Progress log
- [2026-09-16 02:40] checkpoint：新 goal。未嘗試路線：(A) Qwen-3B B2048 Windows（更小 block 更快 forward）；(B) SmolLM2-360M 100MB Windows；(C) Qwen-3B B2048 K1024 WSL（小 block + WSL 加速）；(D) 100MB WSL 重跑（修復 crash）。Blocked：否。
